...
htmlhelp_basename = 'neuralnet-pytorchdoc'
...
latex_documents = [
    (master_doc, 'neuralnet-pytorch.tex', 'neuralnet-pytorch Documentation',
     'Duc Nguyen', 'manual'),
]
...
man_pages = [
    (master_doc, 'neuralnet-pytorch', 'neuralnet-pytorch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'neuralnet-pytorch', 'neuralnet-pytorch Documentation',
     author, 'neuralnet-pytorch', 'One line description of project.',
     'Miscellaneous'),
]
